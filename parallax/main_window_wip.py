...
class MainWindow(QMainWindow):
    def __init__(self, model, dummy=False):
        ...
        self.stage.reticle_calibration_btn.clicked.connect(self.reticle_detection_button_handler)
        ...
        self.probelCalibration = ProbeCalibration(self.stageListener)
    ...
    def reticle_detection_button_handler(self):
        if self.stage.reticle_calibration_btn.isChecked():
            self.stage.reticle_calibration_btn.setStyleSheet(
                "color: gray;"
            ...
            """)
            self.stage.reticle_calibration_btn.setText("Reticle Detection")
    ...
    def reticle_detect_all_screen(self):
        ...
        self.stage.reticle_calibration_btn.setText("Confirm ?")
